         ...
         <div class="card p-4">
             <div class="row">
                 <div class="col">
                     ...
                     <small class="text-secondary ms-3"><span class="opacity-75 me-2">Updated
                             at:</span><strong>{{ date('d/m/Y H:i:s',strtotime($note->updated_at)) }}</strong></small>
                     @endif

                 </div>
                 <div class="col text-end">
                     <a href="{{ route('editNote', ['id' => Crypt::encrypt($note->id)])}}"
                         class="btn btn-outline-secondary btn-sm mx-1"><i class="fa-regular fa-pen-to-square"></i></a>
                     <a href="{{ route('deleteNote', ['id' => Crypt::encrypt($note->id)])}}"
